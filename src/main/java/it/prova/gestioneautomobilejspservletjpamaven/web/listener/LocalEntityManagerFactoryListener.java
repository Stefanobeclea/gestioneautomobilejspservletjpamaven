 package it.prova.gestioneautomobilejspservletjpamaven.web.listener;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("gestioneautomobilejspservletjpamaven_unit");
		} catch (Throwable ex) {
